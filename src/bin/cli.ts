...
program
  ...
  .action(async (hostname: string | undefined, opts: any) => {
    try {
...
program
  ...
  .action(async (ip: string, hosts: string[], opts: any) => {
    try {
      await party
        .setup({
          path: opts.path,
...
program
  ...
  .action(async (ips: string[], opts: any) => {
    try {
      await party
        .setup({
          path: opts.path,
...
program
  ...
  .action(async (hostnames: string[], opts: any) => {
    try {
      await party
        .setup({
          path: opts.path,
